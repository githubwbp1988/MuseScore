...
function do_build() {
    ...
    cmake .. -GNinja \
        ...
        -DCMAKE_C_FLAGS="-s ALLOW_UNDEFINED" \
        -DCMAKE_EXE_LINKER_FLAGS="-pthread -s USE_PTHREADS=1 -s PROXY_TO_PTHREAD=1 -s PTHREAD_POOL_SIZE=4 -s ALLOW_MEMORY_GROWTH=1 -s DISABLE_EXCEPTION_CATCHING=0"
