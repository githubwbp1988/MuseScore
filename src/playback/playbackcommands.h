...
inline static const muse::rcommand::Command SOUND_TOGGLE_COMMAND("command://playback/hear-playback-when-editing-toggle");
inline static const muse::rcommand::Command KEYBOARD_PLAY_OFFSET_COMMAND("command://playback/keyboard-play-offset");
