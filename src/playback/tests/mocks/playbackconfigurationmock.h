...
public:
    ...
    MOCK_METHOD(void, setKeyboardPlayOffset, (int value), (override));
    MOCK_METHOD(int, keyboardPlayOffset, (), (const, override));
    MOCK_METHOD(muse::async::Channel<int>, keyboardPlayOffsetChanged, (), (const, override));
