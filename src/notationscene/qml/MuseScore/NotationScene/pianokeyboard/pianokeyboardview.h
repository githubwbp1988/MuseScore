...
class PianoKeyboardView : public muse::uicomponents::QuickPaintedView, public muse::Contextable, public muse::async::Asyncable
{
    ...
    muse::ContextInject<mu::project::IProjectRWRegister> videoWriters = { this };
...
private:
    ...
    piano_key_t m_clefKeySigs[240] = {
        ...
        61, 63, 65, 66, 68, 70, 72, 73,
        36, 38, 40, 41, 43, 45, 47, 48, // 8 64: F-Clef # sharp  keys  key / 12 - 1 == 2 (C2-C3)
        43, 45, 47, 48, 50, 52, 54, 55,
        ...
        65, 67, 69, 70, 72, 74, 76, 77, // 16 128: G-Clef b flat  keys  key / 12 - 1 == 4 (C4-C5)
        ...
        66, 68, 70, 71, 73, 75, 77, 78,
        71, 73, 75, 76, 78, 80, 82, 83,
        41, 43, 45, 46, 48, 50, 52, 53, // 23 184: F-Clef b flat  keys  key / 12 - 1 == 2 (C2-C3)
        46, 48, 50, 51, 53, 55, 57, 58,
        39, 41, 43, 44, 46, 48, 50, 51,
        44, 46, 48, 49, 51, 53, 55, 56,
        37, 39, 41, 42, 44, 46, 48, 49,
        42, 44, 46, 47, 49, 52, 54, 55,
        47, 49, 51, 52, 54, 56, 58, 59
    };
